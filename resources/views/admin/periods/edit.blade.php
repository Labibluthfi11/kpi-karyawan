    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl border-2 p-6" style="border-color:#16302E; box-shadow:4px 4px 0px 0px #16302E;">
                ...
                <form action="{{ route('admin.periods.update', $period) }}" method="POST" class="space-y-5">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="is_active" value="1" class="rounded" style="accent-color:#F4A261;" {{ old('is_active', $period->is_active) ? 'checked' : '' }}>
