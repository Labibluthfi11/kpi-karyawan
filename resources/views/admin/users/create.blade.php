        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl border-2 p-6" style="border-color:#16302E; box-shadow:4px 4px 0px 0px #16302E;">
                ...
                <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        <label for="name" class="block text-sm font-medium mb-1.5" style="color:#16302E;">Nama</label>
                    ...
                    <div>
                        ...
                        <select id="department_id" name="department_id"
                                ...
                                onblur="this.style.boxShadow='none'; this.style.transform='none';"
                                required>
                            <option value="" {{ old('department_id') === null ? 'selected' : '' }}>Pilih Divisi</option>
                    ...
                    <div>
                        ...
                        <select id="role_id" name="role_id"
                                ...
                                onblur="this.style.boxShadow='none'; this.style.transform='none';"
                                required>
                            <option value="" {{ old('role_id') === null ? 'selected' : '' }}>Pilih Role</option>
                    ...
                    <div>
                        ...
                        <select id="supervisor_id" name="supervisor_id"
                            ...
                            @foreach($potentialSupervisors as $u)
                                <option value="{{ $u->id }}" {{ old('supervisor_id') == $u->id ? 'selected' : '' }}>{{ $u->name }}</option>
                            @endforeach
                        </select>
                        @error('supervisor_id')
                            <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
